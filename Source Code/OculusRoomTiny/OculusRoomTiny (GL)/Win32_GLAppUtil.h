...
// I'm not sure why these guys get pointers to the function. Why don't they just call the funtion later?
// I think that it's so they can use the VALIDATE macro later on.
// I'm trying to fix this, so I am simplifying. JMc.
...
//        WglContext = wglCreateContextAttribsARBFunc(hDC, 0, attribs);
        WglContext = wglCreateContextAttribsARB(hDC, 0, attribs);
